...
pegasus-kickstart  -n count -N ID0000003 -R condorpool  -s even_count.txt=even_count.txt -L workflow3 -T 2020-07-08T23:14:54+00:00 ./count even_nums.txt even_count.txt
job_ec=$?
