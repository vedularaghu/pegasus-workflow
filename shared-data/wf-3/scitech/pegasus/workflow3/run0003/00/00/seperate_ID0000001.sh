...
pegasus-kickstart  -n seperate -N ID0000001 -R condorpool  -s even_nums.txt=even_nums.txt -s odd_nums.txt=odd_nums.txt -L workflow3 -T 2020-07-08T23:43:18+00:00 ./seperate 
job_ec=$?
