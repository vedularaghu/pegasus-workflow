...
pegasus-kickstart  -n count -N ID0000002 -R condorpool  -s odd_count.txt=odd_count.txt -L workflow3 -T 2020-07-08T23:43:18+00:00 ./count odd_nums.txt odd_count.txt
job_ec=$?
