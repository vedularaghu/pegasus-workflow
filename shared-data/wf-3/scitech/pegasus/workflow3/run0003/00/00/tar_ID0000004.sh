...
pegasus-kickstart  -n tar -N ID0000004 -o result.tar.gz -R condorpool  -s result.tar.gz=result.tar.gz -L workflow3 -T 2020-07-08T23:43:18+00:00 /bin/tar odd_count.txt even_count.txt
job_ec=$?
